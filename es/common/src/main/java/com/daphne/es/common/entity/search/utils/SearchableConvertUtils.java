 ...
 */
package com.daphne.es.common.entity.search.utils;

import com.daphne.es.common.entity.search.SearchOperator;
import com.daphne.es.common.entity.search.Searchable;
import com.daphne.es.common.entity.search.exception.InvalidSearchPropertyException;
import com.daphne.es.common.entity.search.exception.InvalidSearchValueException;
import com.daphne.es.common.entity.search.exception.SearchException;
import com.daphne.es.common.entity.search.filter.AndCondition;
import com.daphne.es.common.entity.search.filter.Condition;
import com.daphne.es.common.entity.search.filter.OrCondition;
import com.daphne.es.common.entity.search.filter.SearchFilter;
import com.daphne.es.common.utils.SpringUtils;
...
public final class SearchableConvertUtils {
     ...
     * value="com.daphne.es.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.daphne.es.common.entity.search.utils." +
