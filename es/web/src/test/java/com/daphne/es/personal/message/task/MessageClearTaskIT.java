 ...
 */
package com.daphne.es.personal.message.task;

import com.daphne.es.personal.message.BaseMessageIT;
import com.daphne.es.personal.message.entity.Message;
import com.daphne.es.personal.message.entity.MessageState;
import com.daphne.es.personal.message.task.MessageClearTask;
