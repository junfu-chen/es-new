...
//    	String typeName = String.valueOf(searchable.getValue("type_eq"));
        model.addAttribute("type", AuthType.valueOf(searchable.getValue("type_eq").toString()));
