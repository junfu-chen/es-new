 ...
 */
package com.daphne.es.showcase.parentchild.web.controller;

import com.daphne.es.common.Constants;
import com.daphne.es.common.entity.enums.BooleanEnum;
import com.daphne.es.common.entity.search.SearchOperator;
import com.daphne.es.common.entity.search.Searchable;
import com.daphne.es.common.web.bind.annotation.FormModel;
...
import com.daphne.es.showcase.parentchild.entity.ParentChildType;
import com.daphne.es.showcase.parentchild.service.ChildService;
import com.daphne.es.showcase.parentchild.service.ParentService;
...
public class ParentController extends BaseCRUDController<Parent, Long> {
    ...
    public String view(Model model, @PathVariable("id") Parent m) {
    	model.addAttribute("childList", childService.findByParent(m, null).getContent());
